...
<template>
    <div class="service-bg-animate opacity-10 backdrop-blur-md rounded-3xl shadow-2xl p-4 sm:p-8 md:p-10 mx-1 sm:mx-2 md:mx-10 my-6 sm:my-8">
      <div class="mb-50 service-sect max-w-7xl mx-auto px-2 sm:px-6 md:px-10 lg:px-16 w-full">
        <div class="text-center mb-8 sm:mb-12">
          <h2 class="drop-shadow-lg text-2xl sm:text-3xl md:text-4xl font-extrabold text-green-700 mb-4 select-none bg-white/80 px-4 sm:px-6 py-2 rounded-lg inline-block">
            Our Services
          </h2>
          <br />
          <p class="drop-shadow-lg text-base sm:text-xl text-green-900 select-none bg-white/70 px-3 sm:px-4 py-2 rounded-lg inline-block">
        ...
        <div class="bg-white/90 backdrop-blur-md rounded-2xl sm:rounded-3xl p-4 sm:p-8 md:p-10 shadow-2xl">
          <ul class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8 select-none">
            <li
