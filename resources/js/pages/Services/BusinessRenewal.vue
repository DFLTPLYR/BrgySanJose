...
<template>
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col my-4 relative">
        ...
        <div class="bg-white shadow-md rounded-lg p-6 space-y-6">
            ...
            <div>
              ...
              />
                ...
                <span class="text-base text-white bg-[#0D98BA] px-3 py-1 rounded-lg">Prior Years Business Clearance /Permit
        ...
        ">{{ form.errors.priorYear
              ...
              />
                <label class="block text-gray-700 mb-2 font-semibold mt-2">
                <span class="text-base text-white bg-[#0D98BA] px-3 py-1 rounded-lg">Financial Statement /ITR/Certification of Registration (BIR) <span class="text-xs text-red-400">
                                    *
                            </span>
                            <span class="text-red-600 text-xs" v-if="form.errors.financialState">{{ form.errors.financialState
                            }}</span></span>
                <input
          type="file"
          accept=".jpg,.jpeg,.png,.pdf"
