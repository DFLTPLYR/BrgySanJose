          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label class="block text-gray-700 mb-1">First Name <span class="text-xs text-red-400">
                    ...
                    <span class="text-red-600 text-xs" v-if="form.errors.firstName">{{
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <h2 class="text-lg font-semibold mb-2">Civil Status <span class="text-xs text-red-400">
                    ...
                    <span class="text-red-600 text-xs" v-if="form.errors.civilStatus">{{
          ...
          <div>
            <h2 class="text-lg font-semibold mb-2">Citizenship <span class="text-xs text-red-400">
                    ...
                    <span class="text-red-600 text-xs" v-if="form.errors.citicezenship">{{
                    form.errors.citicezenship
                    }}</span></h2>
        ...
        <div class="space-y-4">
          ...
          <div>
            <label class="block text-gray-700 mb-2 font-semibold">
              <span class="text-base text-white bg-[#0D98BA] px-3 py-1 rounded-lg">Barangay Clearance (Present Address)/ NBI Clearance/ Police Clearance <span class="text-xs text-red-400">
                        *
                    </span>
                    <span class="text-red-600 text-xs" v-if="form.errors.presentId">{{
                    form.errors.presentId
                    }}</span></span>
              <input
                type="file"
                accept=".jpg,.jpeg,.png,.pdf"
                @change="(e)=> handleFileUpload(e,'presentId')"
