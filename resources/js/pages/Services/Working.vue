...
function submitForm() {
    form.post(route('working-clearance-form'), {
        preserveScroll: true, errorBag: 'workingFormErrorForm',
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-gray-700 mb-2 font-semibold">
                            <span class="text-base text-white bg-[#0D98BA] px-3 py-1 rounded-lg">Barangay Clearance
                                (Present Address)/ NBI Clearance/ Police Clearance <span class="text-xs text-red-400">
                                    *
                                </span>
