...
function handleFileUpload(event, field = 'validId') {
  ...
  <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col my-4 relative bg-transparent">
    ...
    <form @submit.prevent="submitForm" class="space-y-6">
      <div class="bg-white shadow-md rounded-lg p-6 space-y-6">
        <!-- Name Section -->
        <div>
          <h2 class="text-lg font-semibold mb-2">Name <span class="text-xs text-red-400">*</span></h2>
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label class="block text-gray-700 mb-1">Last Name <span class="text-xs text-red-400">*</span></label>
              <input v-model="form.lastName" type="text" class="w-full border border-[#0D98BA] rounded px-3 py-2" required />
            </div>
            <div>
              <label class="block text-gray-700 mb-1">First Name <span class="text-xs text-red-400">*</span></label>
              <input v-model="form.firstName" type="text" class="w-full border border-[#0D98BA] rounded px-3 py-2" required />
            </div>
            <div>
              <label class="block text-gray-700 mb-1">Middle Name <span class="text-xs text-red-400">*</span></label>
        ...
        <!-- Provincial Address -->
        <div>
          <h2 class="text-lg font-semibold mb-2">Provincial Address <span class="text-xs text-red-400">*</span></h2>
        ...
        <div>
          <h2 class="text-lg font-semibold mb-2">No. of Years in Tagaytay <span class="text-xs text-red-400">*</span></h2>
          <input v-model="form.yearsInTagaytay" type="number" min="0" class="w-full border border-[#0D98BA] rounded px-3 py-2" required />
        </div>

        <!-- Present Address -->
        <div>
          <h2 class="text-lg font-semibold mb-2">Present Address <span class="text-xs text-red-400">*</span></h2>
          <input v-model="form.presentAddress" type="text" class="w-full border border-[#0D98BA] rounded px-3 py-2" required />
        </div>

        <!-- Contact Number -->
        <div>
          <h2 class="text-lg font-semibold mb-2">Contact Number <span class="text-xs text-red-400">*</span></h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <h2 class="text-lg font-semibold mb-2">Civil Status <span class="text-xs text-red-400">*</span></h2>
            <input v-model="form.civilStatus" type="text" class="w-full border border-[#0D98BA] rounded px-3 py-2" required />
          </div>
          <div>
            <h2 class="text-lg font-semibold mb-2">Citizenship <span class="text-xs text-red-400">*</span></h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <h2 class="text-lg font-semibold mb-2">Birthdate <span class="text-xs text-red-400">*</span></h2>
            <input v-model="form.birthdate" type="date" class="w-full border border-[#0D98BA] rounded px-3 py-2" required />
          </div>
          <div>
            <h2 class="text-lg font-semibold mb-2">Birthplace <span class="text-xs text-red-400">*</span></h2>
            <input v-model="form.birthplace" type="text" class="w-full border border-[#0D98BA] rounded px-3 py-2" required />
          </div>
          <div>
            <h2 class="text-lg font-semibold mb-2">Age <span class="text-xs text-red-400">*</span></h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <h2 class="text-lg font-semibold mb-2">Occupation <span class="text-xs text-red-400">*</span></h2>
            <input v-model="form.occupation" type="text" class="w-full border border-[#0D98BA] rounded px-3 py-2" required />
          </div>
          <div>
            <h2 class="text-lg font-semibold mb-2">Name of Company <span class="text-xs text-red-400">*</span></h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <h2 class="text-lg font-semibold mb-2">Name of Spouse <span class="text-xs text-red-400">*</span></h2>
            <input v-model="form.spouseName" type="text" class="w-full border border-[#0D98BA] rounded px-3 py-2" required />
          </div>
          <div>
            <h2 class="text-lg font-semibold mb-2">Spouse Occupation  <span class="text-xs text-red-400">*</span></h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <h2 class="text-lg font-semibold mb-2">Father's Name  <span class="text-xs text-red-400">*</span></h2>
            <input v-model="form.fatherName" type="text" class="w-full border border-[#0D98BA] rounded px-3 py-2" required />
          </div>
          <div>
            <h2 class="text-lg font-semibold mb-2">Father's Occupation <span class="text-xs text-red-400">*</span></h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <h2 class="text-lg font-semibold mb-2">Mother's Name <span class="text-xs text-red-400">*</span></h2>
            <input v-model="form.motherName" type="text" class="w-full border border-[#0D98BA] rounded px-3 py-2" required />
          </div>
          <div>
            <h2 class="text-lg font-semibold mb-2">Mother's Occupation <span class="text-xs text-red-400">*</span></h2>
        ...
        <div class="space-y-4">
          ...
          <div>
            <label class="block text-gray-700 mb-2 font-semibold">
              <span class="text-base text-white bg-[#0D98BA] px-3 py-1 rounded-lg">Barangay Clearance (Present Address)/ NBI Clearance/ Police Clearance</span>
              <input
                type="file"
        ...
        <div>
          <button
            type="submit"
            class="bg-[#0D98BA] text-white px-4 py-2 rounded hover:bg-[#0A7A9C] flex items-center justify-center ease-in-out duration-300 w-full"
          >
            Submit
          </button>
        </div>
