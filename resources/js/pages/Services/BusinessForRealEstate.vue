...
const form = useForm({
    ...
    taxDeclaration: null,    // added for file
    email: '',
})
        ...
        <div class="bg-white shadow-md rounded-lg p-6 space-y-6">
            ...
            <div>
              ...
              />
                ...
                <span class="text-base text-white bg-[#0D98BA] px-3 py-1 rounded-lg">Tax Declaration/Land Title
                    <span class="text-xs text-red-400">
                                    *
                            </span>
                            <span class="text-red-600 text-xs" v-if="form.errors.taxDeclaration
        ">{{ form.errors.taxDeclaration
                ...
                type="file"
                accept=".jpg,.jpeg,.png,.pdf"
                @change="(e) => handleFileUpload(e, 'taxDeclaration')"
                class="block w-full mt-2 border-2 border-[#0D98BA] rounded px-3 py-2 bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#0D98BA] cursor-pointer"
            />
