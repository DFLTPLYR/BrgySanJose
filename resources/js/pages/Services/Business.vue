...
const form = useForm({
    ...
    contractLease: null,
    sketchBusiness: null,
    listEmployee: null,       // added for file
    email: '',
})
...
function submitForm() {
    form.post(route('business-clearance-form'), { preserveScroll: true, errorBag: 'businessErrorForm', onError: e => console.log(e), onSuccess: () => form.reset() });
}
</script>
...
<template>
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col my-4 relative">
        ...
        <div class="bg-white shadow-md rounded-lg p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <label class="block text-gray-700 mb-1">Middle Name
                            <span class="text-red-600 text-xs" v-if="form.errors.middleName">{{ form.errors.middleName
                            }}</span></label>
            ...
            <h2 class="text-lg font-semibold mb-2">Provincial Address <span class="text-xs text-red-400">
                            ...
                            <span class="text-red-600 text-xs" v-if="form.errors.provincialAddress">{{ form.errors.provincialAddress
                            }}</span></h2>
            ...
            <h2 class="text-lg font-semibold mb-2">No. of Years in Tagaytay <span class="text-xs text-red-400">
                            ...
                            <span class="text-red-600 text-xs" v-if="form.errors.yearsInTagaytay">{{ form.errors.yearsInTagaytay
                            }}</span></h2>
            ...
            <h2 class="text-lg font-semibold mb-2">Present Address <span class="text-xs text-red-400">
                            ...
                            <span class="text-red-600 text-xs" v-if="form.errors.presentAddress">{{ form.errors.presentAddress
                            }}</span></h2>
            ...
            <div>
                <h2 class="text-lg font-semibold mb-2">Birthplace <<span class="text-xs text-red-400">
                            ...
                            <span class="text-red-600 text-xs" v-if="form.errors.birthplace">{{ form.errors.birthplace
                            }}</span></h2>
            ...
            <div>
                <h2 class="text-lg font-semibold mb-2">Spouse Occupation  <<span class="text-xs text-red-400">
                            ...
                            <span class="text-red-600 text-xs" v-if="form.errors.spouseOccupation">{{ form.errors.spouseOccupation
                            }}</span></h2>
            ...
            <div>
                <h2 class="text-lg font-semibold mb-2">Father's Occupation <span class="text-xs text-red-400">
                            ...
                            <span class="text-red-600 text-xs" v-if="form.errors.fatherOccupation">{{ form.errors.fatherOccupation
                            }}</span></h2>
            ...
            <div>
                <h2 class="text-lg font-semibold mb-2">Mother's Name <<span class="text-xs text-red-400">
                            ...
                            <span class="text-red-600 text-xs" v-if="form.errors.motherName">{{ form.errors.motherName
                            }}</span></h2>
            ...
            <div>
                <h2 class="text-lg font-semibold mb-2">Mother's Occupation <span class="text-xs text-red-400">
                            ...
                            <span class="text-red-600 text-xs" v-if="form.errors.motherOccupation">{{ form.errors.motherOccupation
                            }}</span></h2>
            ...
            <div>
                ...
                <span class="text-base text-white bg-[#0D98BA] px-3 py-1 rounded-lg">2x2 Latest Picture <span class="text-xs text-red-400">
                                    *
                            </span>
                            <span class="text-red-600 text-xs" v-if="form.errors.latestPhoto">{{ form.errors.latestPhoto
                            }}</span></span>
              ...
              />
                ...
                <span class="text-base text-white bg-[#0D98BA] px-3 py-1 rounded-lg">DTI/SEC Registration
                    <span class="text-xs text-red-400">
                                    *
                            </span>
                            <span class="text-red-600 text-xs" v-if="form.errors.dtiSec">{{ form.errors.dtiSec
                            }}</span>
              ...
              />
                <label class="block text-gray-700 mb-2 font-semibold mt-2">
                <span class="text-base text-white bg-[#0D98BA] px-3 py-1 rounded-lg">Contract of Lease/ Title/Certification <span class="text-xs text-red-400">
                                    *
                            </span>
                            <span class="text-red-600 text-xs" v-if="form.errors.contractLease">{{ form.errors.contractLease
                            }}</span></span>
                <input
          type="file"
          accept=".jpg,.jpeg,.png,.pdf"
        ...
        />
                <label class="block text-gray-700 mb-2 font-semibold mt-2">
                <span class="text-base text-white bg-[#0D98BA] px-3 py-1 rounded-lg">Sketch of Business Location <span class="text-xs text-red-400">
                                    *
                            </span>
                            <span class="text-red-600 text-xs" v-if="form.errors.sketchBusiness">{{ form.errors.sketchBusiness
                            }}</span>
                </span>
        ...
        />
                <label class="block text-gray-700 mb-2 font-semibold mt-2">
                <span class="text-base text-white bg-[#0D98BA] px-3 py-1 rounded-lg">List of Employees (Regular & Contractual) <span class="text-xs text-red-400">
                                    *
                            </span>
                            <span class="text-red-600 text-xs" v-if="form.errors.listEmployee">{{ form.errors.listEmployee
                            }}</span>
                </span>
                <input
          type="file"
