...
async function submitForm() {
  ...
  // Prepare FormData to send files and other fields
  ...
  try {
    ...
    const response = await fetch('https://your-backend-url/api/submit-form', {
      method: 'POST',
      body: formData,
    })
...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col my-4 relative">
    ...
    <div class="bg-white shadow-md rounded-lg p-6 space-y-6">
        ...
        <div>
            <label class="block text-gray-700 mb-2 font-semibold">
            <span class="text-base text-white bg-[#0D98BA] px-3 py-1 rounded-lg">2x2 Picture <span class="text-xs text-red-400">
                        *
                    </span>
