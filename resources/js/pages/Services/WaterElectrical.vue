...
function submitForm() {
    form.post(route('water-electrical-permit-form'), { preserveScroll: true, errorBag: 'waterElectricalErrorForm', onError: e => console.log(e), onSuccess: () => form.reset() });
}
</script>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col my-4 relative">
        ...
        <div>
            <p class="text-gray-600 mb-6 justify-center flex items-center">
                Please fill out the form below to apply for a Water Electrical.
            </p>
        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-gray-700 mb-2 font-semibold">
                            <span class="text-base text-white bg-[#0D98BA] px-3 py-1 rounded-lg">Land Title / Tax
                                Declaration <span class="text-xs text-red-400">
                                    *
                                </span>
                    ...
                    <div>
                        <label class="block text-gray-700 mb-2 font-semibold">
                            <span class="text-base text-white bg-[#0D98BA] px-3 py-1 rounded-lg">2x2 Picture <span
                                    class="text-xs text-red-400">
                                    *
                                </span>
                                <span class="text-red-600 text-xs" v-if="form.errors.latestPicture">{{
                                    form.errors.latestPicture
                                    }}</span></span>
                            <input type="file" accept=".jpg,.jpeg,.png,.pdf"
                                @change="(e) => handleFileUpload(e, 'latestPicture')"
                                class="block w-full mt-2 border-2 border-[#0D98BA] rounded px-3 py-2 bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#0D98BA] cursor-pointer" />
                        </label>
                    </div>
                    <div>
